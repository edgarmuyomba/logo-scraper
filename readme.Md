...
> This project was used to collect data as part of the preparatory stages for the [Logo API](https://github.com/edgarmuyomba/logoAPI.git) - A free api used to retrieve various company logos. Check out the live demo [here]()
